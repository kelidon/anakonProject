...
class AppStyles {
  ...
  static const TextStyle COMPANY_OVERLAY = TextStyle(
      color: Color(0xFF06285A), fontSize: 24, fontWeight: FontWeight.w600);
...
//mobile
  ...
  static const TextStyle DRAWER_TITLE_M = TextStyle(
      fontSize: 20,
      color: Color(0xFF020E31),
      fontWeight: FontWeight.bold,
      height: 1.3);
  ...
  static const TextStyle CONTACTS_APPBAR_M = TextStyle(
      color: Color(0xFF06285A), fontSize: 10, fontWeight: FontWeight.w600);

  static const TextStyle TITLE_M = TextStyle(
      color: Color(0xFF06285A), fontSize: 16, fontWeight: FontWeight.w600);

  static const TextStyle COMPANY_OVERLAY_M = TextStyle(
      color: Color(0xFF06285A), fontSize: 18, fontWeight: FontWeight.w600);

  static const TextStyle TITLE_S_M = TextStyle(
      color: Color(0xFF06285A), fontSize: 14, fontWeight: FontWeight.w600);

  static const TextStyle CONTACT_BUTTON_M = TextStyle(
      color: AppColors.PRIMARY, fontSize: 16, fontWeight: FontWeight.w600);

  static const TextStyle CONTACT_TEXT_M = TextStyle(
      color: Color(0xFF06285A), fontSize: 14, fontWeight: FontWeight.w600);

  static const TextStyle REGULAR_SERVICES_M = TextStyle(
      fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.PRIMARY);

  static const TextStyle SERVICES_REGULAR_M = TextStyle(
      fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.PRIMARY);

  static const TextStyle BS_TITLE = TextStyle(
      fontSize: 16, fontWeight: FontWeight.w600, color: AppColors.PRIMARY);

  static const TextStyle BS_REGULAR = TextStyle(
      fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.PRIMARY);
