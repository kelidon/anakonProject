    ...
    return InkWell(
        onTap: () {
          if(context.bloc<CollapsedHeadersBloc>().state.key == titleType){
            if(context.bloc<CollapsedHeadersBloc>().state.value == CollapsingState.COLLAPSED)
      ...
      builder: (_, state) {
        ...
        return isCollapsed
          ...
          margin: EdgeInsets.only(bottom: 10),
                ...
                height: 50,
                color: Colors.green,
          child: Center(child: Icon(TypeToStateMapper.typeToStateMap[titleType].key)),
              )
            : Container(
          margin: EdgeInsets.only(bottom: 10),
          ...
          child: Row(
            children: [
              Container(width: 50,
                  height: 50,child: Center(child: Icon(TypeToStateMapper.typeToStateMap[titleType].key))),
              SizedBox(width: 10,),
