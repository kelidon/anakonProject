...
class ServicesTargetWidget extends StatelessWidget {
  ...
  const ServicesTargetWidget({Key key, this.tag, this.mainContext})
      : super(key: key);
                ...
                children: [
                  ...
                  Flexible(
                    child: Container(
                        ...
                        child: Text(
                          ServicesTypeToStateMapper.typeToStateMap[tag].value,
                          style: isMouse
                              ? AppStyles.SERVICES_REGULAR
                              : AppStyles.SERVICES_REGULAR_M,
