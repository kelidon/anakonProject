...
class CollapsingTypeToStateMapper {
  static const typeToStateMap = {
    ...
    CollapsingTitle.HOW_WORK_2: MapEntry(
        AnakonGreek.E,
    ...
    CollapsingTitle.HOW_WORK_3: MapEntry(
        AnakonGreek.o,
